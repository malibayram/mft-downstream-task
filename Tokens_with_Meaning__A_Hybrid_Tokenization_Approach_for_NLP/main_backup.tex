...
\caption{STS benchmark test split results across training steps (from \texttt{STS\_BENCHMARK\_RESULTS.md}).}
\label{fig:sts_chart}
\end{figure}
...
\caption{Overall average MTEB-TR scores across evaluated models (from \texttt{MTEB\_BENCHMARK\_RESULTS.md}).}
\label{fig:mteb_avg}
\end{figure}
...
\caption{Checkpoint-history robustness on STSb-TR (Pearson/Spearman), from \texttt{VERSION\_BENCHMARK\_RESULTS.md}.}
