...
The affix lexicon encodes productive suffixes and function markers. Each affix identifier can correspond to multiple surface allomorphs. For example, vowel harmony yields alternations over \{a, e\} and \{ı, i, u, ü\}, and consonant hardness can yield alternations such as \textit{d/t}. Instead of treating each surface form as a distinct token, we group them into equivalence classes and select the appropriate surface form at decode time based on phonological context.
